...
class USDataAugmentation():
    ...
    def build(self):
        ...
        self._random_rotation = tf.keras.layers.RandomRotation(factor=0.0639, fill_mode='constant', seed=self.random_state)
